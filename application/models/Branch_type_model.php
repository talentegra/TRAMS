...
/* Location: ./application/models/Branch_type_model.php */
...
class Branch_type_model extends CI_Model
{

    public $table = 'branch_type';
    public $id = 'branch_type_id';
    public $order = 'DESC';
    ...
    function total_rows($q = NULL) {
        $this->db->like('branch_type_id', $q);
	$this->db->or_like('branch_type_name', $q);
...
/* End of file Branch_type_model.php */