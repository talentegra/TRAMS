...
/* Location: ./application/models/Interest_level_model.php */
...
class Interest_level_model extends CI_Model
{

    public $table = 'interest_level';
    public $id = 'interest_level_id';
    public $order = 'DESC';
	...
	// get all data array
    function get_all_interest_level()
    {
        $this->db->order_by($this->id, $this->order);
    ...
    function get_interest_level($id)
    {
        $this->db->where($this->id, $id);
    ...
    function total_rows($q = NULL) {
        $this->db->like('interest_level_id', $q);
...
/* End of file Interest_level_model.php */