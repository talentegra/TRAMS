...
/* Location: ./application/models/Batch_pattern_model.php */
...
class Batch_pattern_model extends CI_Model
{

    public $table = 'batch_pattern';
    public $id = 'batch_pattern_id';
    public $order = 'DESC';
	...
	// get all data array
    function get_all_batch_pattern()
    {
        $this->db->order_by($this->id, $this->order);
    ...
    function total_rows($q = NULL) {
        $this->db->like('batch_pattern_id', $q);
...
/* End of file Batch_pattern_model.php */