...
/* Location: ./application/models/Package_course_model.php */
...
class Package_course_model extends CI_Model
{
	...
	// get all data array
    function get_all_package_course()
    {
        $this->db->order_by($this->id, $this->order);
    ...
    function get_package_course($id)
    {
        $this->db->where($this->id, $id);
...
/* End of file Package_course_model.php */