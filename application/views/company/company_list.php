    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
			   ...
			   <h2>Company List <small>Manage Company</small></h2>
                        <div style="float: right;"><a href="<?php echo base_url('company/create'); ?>"><button class="btn btn-success" type="button">Create Company</button></a></div>
                        <div class="clearfix"></div>
 ...
 <script type='text/javascript'>
    ...
    function load_list(page) {
        ...
        $.ajax({
            type: 'POST',
            data: dataString,
            url: '<?php echo base_url(); ?>company/list_data/' + page, //The url where the server req would we made.
