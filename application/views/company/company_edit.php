...
<input type="hidden"  name="company_id" name="company_id" value="<?php echo $company_id; ?>" />
	    ...
	    <div class=" form-group"> 
            <label class="col-md-6 col-sm-6 col-xs-12" for="company_address">Company Address</label>
            <div class="col-sm-6">
			<textarea class="form-control" rows="3" name="company_address" id="company_address" placeholder="Company Address"><?php echo $company_address; ?></textarea>
	    ...
	    <div class=" form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
			<input type="text" class="form-control col-md-7 col-xs-12" name="company_pincode" id="company_pincode" placeholder="Company Pincode" value="<?php echo $company_pincode; ?>" />
	    ...
	    <div class=" form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
			<input type="text" class="form-control col-md-7 col-xs-12" name="company_email" id="company_email" placeholder="Company Email" value="<?php echo $company_email; ?>" />
	    ...
	    <div class=" form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
			<input type="text" class="form-control col-md-7 col-xs-12" name="company_domain" id="company_domain" placeholder="Company Domain" value="<?php echo $company_domain; ?>" />
	    ...
	    <div class=" form-group">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
			<input type="text" class="form-control col-md-7 col-xs-12" name="company_phone" id="company_phone" placeholder="Company Phone" value="<?php echo $company_phone; ?>" />
