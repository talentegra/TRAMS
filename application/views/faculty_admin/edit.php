            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form class="form-horizontal form-label-left" data-parsley-validate="" id="demo-form2" novalidate="" method="post" action="<?php echo base_url('faculty_admin/edit/'.$faculty_admin['id']); ?>">
				...
				foreach($faculties as $faculty)
				{
                                    ...
                                    echo '<option value="'.$faculty['id'].'" '.$selected.'>'.$faculty['faculty_name']."</option>";
				} 
				?>
			</select>
                        </div>
