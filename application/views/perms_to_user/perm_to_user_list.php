    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
			   ...
			   <h2>Arbac_perm_to_user List <small>Manage Arbac_perm_to_user</small></h2>
                        <div style="float: right;"><a href="<?php echo base_url('perm_to_user/create'); ?>"><button class="btn btn-success" type="button">Create Arbac_perm_to_user</button></a></div>
                        <div class="clearfix"></div>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn" id="btn_grp">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('perm_to_user'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
 ...
 <script type='text/javascript'>
    ...
    function load_list(page) {
        ...
        $.ajax({
            type: 'POST',
            data: dataString,
            url: '<?php echo base_url(); ?>perm_to_user/list_data/' + page, //The url where the server req would we made.
            ...
            success: function(data) {
                ...
                if(sort_column!=''){
					if(sort_column != 'perm_to_user_id'){
