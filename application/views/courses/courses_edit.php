...
<input type="hidden"  name="course_id" name="course_id" value="<?php echo $course_id; ?>" />
	    <div class=" form-group">
					 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="int">Category Id</label>
