    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
			   ...
			   <h2>Arbac_perms List <small>Manage Arbac_perms</small></h2>
                        <div style="float: right;"><a href="<?php echo base_url('perms/create'); ?>"><button class="btn btn-success" type="button">Create Arbac_perms</button></a></div>
                        <div class="clearfix"></div>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn" id="btn_grp">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('perms'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
 ...
 <script type='text/javascript'>
    ...
    function load_list(page) {
        ...
        $.ajax({
            type: 'POST',
            data: dataString,
            url: '<?php echo base_url(); ?>permissions/list_data/' + page, //The url where the server req would we made.
