    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
			   ...
			   <h2>Batches List <small>Manage Batches</small></h2>
                        <div style="float: right;"><a href="<?php echo base_url('batches/create'); ?>"><button class="btn btn-success" type="button">Create Batches</button></a></div>
                        <div class="clearfix"></div>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn" id="btn_grp">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('batches'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
 ...
 <script type='text/javascript'>
    ...
    function load_list(page) {
        ...
        $.ajax({
            type: 'POST',
            data: dataString,
            url: '<?php echo base_url(); ?>batches/list_data/' + page, //The url where the server req would we made.
