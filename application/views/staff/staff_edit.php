        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br>
<input type="hidden"  name="staff_id" name="staff_id" value="<?php echo $staff_id; ?>" />
	    <div class=" form-group">
					 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="int">Org Id</label>
					...
					<select class="form-control col-md-7 col-xs-12" name="branch_id" id="branch_id" placeholder="Branch Id" value="<?php echo $branch_id; ?>" >
						...
						if ($branch_list) {
							foreach ($branch_list as $branch_data) {
								if($branch_id == $branch_data->branch_type_id) {
									$selected = "selected";
								}
								else
								{
	    ...
	    <div class=" form-group">
					 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="int">Group Id</label>
					<div class="col-md-6 col-sm-6 col-xs-12">
	    ...
	    <div class=" form-group">
					 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="int">Designation Id</label>
					<div class="col-md-6 col-sm-6 col-xs-12">
	    ...
	    <div class=" form-group">
					 <label class="control-label col-md-3 col-sm-3 col-xs-12" for="varchar">Lang</label>
					<div class="col-md-6 col-sm-6 col-xs-12">
