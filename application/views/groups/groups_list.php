    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
			   ...
			   <h2>Arbac_groups List <small>Manage Arbac_groups</small></h2>
                        <div style="float: right;"><a href="<?php echo base_url('groups/create'); ?>"><button class="btn btn-success" type="button">Create Arbac_groups</button></a></div>
                        <div class="clearfix"></div>
 ...
 <script type='text/javascript'>
    ...
    function load_list(page) {
        ...
        $.ajax({
            type: 'POST',
            data: dataString,
            url: '<?php echo base_url(); ?>groups/list_data/' + page, //The url where the server req would we made.
