            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <div style="float: right;"><a href="<?php echo base_url('account_type/create'); ?>"><button class="btn btn-success" type="button">Create Account_type</button></a></div>
                        <div class="clearfix"></div>
                            ...
                            <div class="col-md-3 text-right">
                                <div class="input-group">
                                    ...
                                    <span class="input-group-btn" id="btn_grp">
                                        ...
                                        if ($q <> '') {
                                            ?>
                                            <a href="<?php echo site_url('account_type'); ?>" class="btn btn-default">Reset</a>
                                            <?php
                                        }
                                        ?>
...
<script type='text/javascript'>
    ...
    function load_list(page) {
        ...
        $.ajax({
            type: 'POST',
            data: dataString,
            url: '<?php echo base_url(); ?>account_type/list_data/' + page, //The url where the server req would we made.
