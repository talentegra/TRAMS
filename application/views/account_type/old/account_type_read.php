<div role="main" class="right_col" style="min-height: 3687px;">
	...
	<div class="clearfix"></div>
        ...
        <table class="table">
	    <tr><td>Account Mode</td><td><?php echo $account_mode; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('account_type') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
