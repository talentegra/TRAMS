    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
			   ...
			   <h2>Candidate_requirement List <small>Manage Candidate_requirement</small></h2>
                        <div style="float: right;"><a href="<?php echo base_url('candidate_requirement/create'); ?>"><button class="btn btn-success" type="button">Create Candidate_requirement</button></a></div>
                        <div class="clearfix"></div>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn" id="btn_grp">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('candidate_requirement'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
 ...
 <script type='text/javascript'>
    ...
    function load_list(page) {
        ...
        $.ajax({
            type: 'POST',
            data: dataString,
            url: '<?php echo base_url(); ?>candidate_requirement/list_data/' + page, //The url where the server req would we made.
            ...
            success: function(data) {
                ...
                if(sort_column!=''){
					if(sort_column != 'candidate_requirement_id'){
                    var string = $('#'+sort_column).html();
                    if(sortby=='ASC'){
                        string = string.replace(/fa fa-sort|glyphicon glyphicon-triangle-bottom|glyphicon glyphicon-triangle-top/gi, 'glyphicon-triangle-top');
                    }
                    else{
                        string = string.replace(/fa fa-sort|glyphicon glyphicon-triangle-bottom|glyphicon glyphicon-triangle-top/gi, 'glyphicon-triangle-bottom');	
                    }
