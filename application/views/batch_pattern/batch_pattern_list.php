    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
			   ...
			   <h2>Batch_pattern List <small>Manage Batch_pattern</small></h2>
                        <div style="float: right;"><a href="<?php echo base_url('batch_pattern/create'); ?>"><button class="btn btn-success" type="button">Create Batch_pattern</button></a></div>
                        <div class="clearfix"></div>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn" id="btn_grp">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('batch_pattern'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
 ...
 <script type='text/javascript'>
    ...
    function load_list(page) {
        ...
        $.ajax({
            type: 'POST',
            data: dataString,
            url: '<?php echo base_url(); ?>batch_pattern/list_data/' + page, //The url where the server req would we made.
            ...
            success: function(data) {
                ...
                if(sort_column!=''){
					if(sort_column != 'batch_pattern_id'){
