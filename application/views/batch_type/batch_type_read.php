<div role="main" class="right_col" style="min-height: 3687px;">
	...
	<div class="clearfix"></div>
        ...
        <table class="table">
	    <tr><td>Batch Type Name</td><td><?php echo $batch_type_name; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('batch_type') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>
