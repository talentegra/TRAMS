        ...
        <div class="animate form login_form">
          <section class="login_content">
            <?php echo form_open("auth/login");?>
              <h1>Login Form</h1>
              <div>
                <input type="text" class="form-control" placeholder="Email" required="required" id="identity" name ="identity" />
              </div>
              <div>
              ...
              <div class="separator">
                <div>
                  <h1><i class="fa fa-paw"></i> Training Management Software</h1>
