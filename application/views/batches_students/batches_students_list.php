    ...
    <div class="">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
			   ...
			   <h2>Batches_students List <small>Manage Batches_students</small></h2>
                        <div style="float: right;"><a href="<?php echo base_url('batches_students/create'); ?>"><button class="btn btn-success" type="button">Create Batches_students</button></a></div>
                        <div class="clearfix"></div>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn" id="btn_grp">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('batches_students'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
 ...
 <script type='text/javascript'>
    ...
    function load_list(page) {
        ...
        $.ajax({
            type: 'POST',
            data: dataString,
            url: '<?php echo base_url(); ?>batches_students/list_data/' + page, //The url where the server req would we made.
            ...
            success: function(data) {
                ...
                if(sort_column!=''){
					if(sort_column != 'batches_students_id'){
