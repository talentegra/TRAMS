...
/* Modified by Vivek Raghunathan 2016-06-21 15:45:19 */
...
class Account_type extends APP_Controller
{
    ...
    public function list_data()
    {
        ...
        $config['base_url'] = base_url(). 'Account_type/list_data';
        $config['total_rows'] = $this->Account_type_model->total_rows($q);
        $config['per_page'] = $this->perPage;

        $this->ajax_pagination->initialize($config);

        //get the posts data
        $account_type_data = $this->Account_type_model->get_limit_data($config['per_page'], $offset,$sort_column ,$sort_by , $q);
        ...
        //load the view
        $this->load->view('account_type/account_type_list_data', $data);
    }
