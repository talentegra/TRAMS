...
/* Modified by Vivek Raghunathan 2016-06-21 15:53:47 */
...
class Source extends APP_Controller
{
    ...
    public function list_data()
    {
        ...
        $config['div'] = 'Source_list'; //parent div tag id
        $config['base_url'] = base_url(). 'Source/list_data';
        $config['total_rows'] = $this->Source_model->total_rows($q);
        $config['per_page'] = $this->perPage;

        $this->ajax_pagination->initialize($config);

        //get the posts data
        $source_data = $this->Source_model->get_limit_data($config['per_page'], $offset,$sort_column ,$sort_by , $q);
        ...
        //load the view
        $this->load->view('source/source_list_data', $data);
    }
