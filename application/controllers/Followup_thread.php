...
class Followup_thread extends APP_Controller
{
    ...
    public function create() 
    {
	    ...
	    'followup_id' => set_value('followup_id'),
	    'pid' => set_value('pid'),
    ...
    {
	$this->form_validation->set_rules('followup_id', 'followup id', 'trim|required|numeric');
	$this->form_validation->set_rules('pid', 'pid', 'trim|required|numeric');
	$this->form_validation->set_rules('followup_type', 'followup type', 'trim|required|numeric');
	$this->form_validation->set_rules('interest_level', 'interest level', 'trim|required|numeric');
	$this->form_validation->set_rules('followup_date', 'followup date', 'trim|required');
	$this->form_validation->set_rules('followup_action', 'followup action', 'trim|required|numeric');
	...
	$this->form_validation->set_rules('next_followup_action', 'next followup action', 'trim|required|numeric');
