...
/* Modified by Vivek Raghunathan 2016-06-21 15:57:16 */
...
class Status_type extends APP_Controller
{
    ...
    public function list_data()
    {
        ...
        $config['div'] = 'Status_type_list'; //parent div tag id
        $config['base_url'] = base_url(). 'Status_type/list_data';
        $config['total_rows'] = $this->Status_type_model->total_rows($q);
        $config['per_page'] = $this->perPage;

        $this->ajax_pagination->initialize($config);

        //get the posts data
        $status_type_data = $this->Status_type_model->get_limit_data($config['per_page'], $offset,$sort_column ,$sort_by , $q);
        ...
        //load the view
        $this->load->view('status_type/status_type_list_data', $data);
    }
